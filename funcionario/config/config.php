...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4" style="margin-left: 250px; padding-top: 50px;">
    ...
    <?php if (!empty($funcionario['foto'])): ?>
        <label class="custom-file-upload">
            <img id="imgPreview" src="../../uploads/fotos/<?php echo htmlspecialchars($funcionario['foto']); ?>" alt="" style="width: 110px; height: 100px; object-fit: cover;">
    ...
    <?php endif; ?>
        ...
        <div class="form-group">
            <label>Nome:</label>
            <span class="editable" data-field="nome" onclick="enableEdit(this)"><?php echo htmlspecialchars($funcionario['nome'] ?? 'N/A'); ?></span>
        </div>
        <div class="form-group">
            <label>E-mail:</label>
            <span class="editable" data-field="email" onclick="enableEdit(this)"><?php echo htmlspecialchars($funcionario['email'] ?? 'N/A'); ?></span>
        </div>
        <div class="form-group">
            <label>Telefone:</label>
            <span class="editable" data-field="telefone" onclick="enableEdit(this)"><?php echo htmlspecialchars($funcionario['telefone'] ?? 'N/A'); ?></span>
        </div>
        <div class="form-group">
            <label>CPF:</label>
            <span class="editable" data-field="cpf" onclick="enableEdit(this)"><?php echo htmlspecialchars($funcionario['cpf'] ?? 'N/A'); ?></span>
        </div>
        <div class="form-group">
            <label>Senha:</label>
